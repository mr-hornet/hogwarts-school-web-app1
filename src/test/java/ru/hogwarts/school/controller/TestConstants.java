...
public class TestConstants {
    ...
    public static final String MOCK_FACULTY_NAME = "Student name";
    public static final String MOCK_FACULTY_NEW_NAME = "Student new name";
    ...
    public static final Student MOCK_STUDENT = new Student(MOCK_STUDENT_ID, MOCK_STUDENT_NAME, MOCK_STUDENT_AGE, MOCK_FACULTY);
